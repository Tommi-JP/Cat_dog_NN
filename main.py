...
def main():
    u_input = input("If you already have a model and want test it, you can skip training. Do you want to skip training? (Y/N)")
    if u_input in ["Y", "y", "Yes", "yes"]:
       os.system("streamlit run streamlit_main.py")
       sys.exit()
